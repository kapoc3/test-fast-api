...
# WARNING: Ensure imports from `test_fast_api` comes after this line
from test_fast_api import app, settings, db  # noqa
from test_fast_api.cli import create_user, cli  # noqa
