...
description = """
test_fast_api API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://test_fast_api.com/terms/",
    contact={
        "name": "kapoc3",
        "url": "http://test_fast_api.com/contact/",
        "email": "kapoc3@test_fast_api.com",
    },
    license_info={
        "name": "The Unlicense",
